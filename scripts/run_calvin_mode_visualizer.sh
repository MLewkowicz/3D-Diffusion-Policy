...
cd /data/scratch/aryannav/diffusion-steering/3D-Diffusion-Policy
mkdir -p logs

python -m utils.calvin_mode_visualizer /data/scratch/mlewkowicz/calvin/dataset/task_D_D --split training -o out --verbose
